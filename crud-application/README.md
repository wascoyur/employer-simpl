...
3. Элементы списка имеют несколько сохраняемых полей. </br>Поля сохраняемых элементов можно увидет в меню  EntityList (после из добавления в список на странице EntityAdd).
